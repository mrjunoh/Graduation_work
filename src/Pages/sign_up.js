    ...
    return(
        <Container component="main" maxWidth="xs">
            <Box sx={{ marginTop: 8, display: 'flex', flexDirection: 'column', alignItems: 'center', }} >
                ...
                <TextField margin="normal" label="아이디" required fullWidth name="email" autoFocus value={id} onChange={(event)=>{setID(event.target.value);}}/>
                ...
                <Button type="submit" fullWidth variant='contained' sx={{ mt : 3, mb : 2}} onClick={()=>{}}>회원가입</Button>
                <Grid container>
                    <Grid item xs>
                    </Grid>
                    <Grid item>
